...
output "logging_account_id" { value = aws_organizations_account.logging.id }
output "shared_services_account_id" { value = aws_organizations_account.shared_services.id }
output "development_account_id" { value = aws_organizations_account.development.id }
